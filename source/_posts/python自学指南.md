...
这大概是我见过最无聊的技能了，Office套件内是内建了一种脚本语言VBA的支持的。如果你是一位文职人员，想自动化一些在Office内的重复劳动，比起学习Python来，学习VBA更适合你。相比Python，VBA具有许多独有的优势。

1. 拥有大量前人留下的脚本。

   例如判断身份证正确与否，计算收益等等常见的功能，只需要修改一下变量就可以使用，网络上随处可以搜索到。VBA操作Office中表格、段落、字体等对象的教程和问答也更多，微软亦提供了详尽的[中文文档](https://docs.microsoft.com/zh-cn/office/vba/api/overview/)，可以帮助你少走许多弯路。

2. 微软内建了许多功能，与Office套件结合性更好，并能随文件附带。

   Python操作Office文档，一些功能需要等待第三方适配。而微软自带的工具则预置了几乎所有的功能，编写和操作也更加方便，录制宏功能可以让对VBA不太了解的人也能快速完成一个脚本。同时，VBA语言编写的宏可以随docx、xlsx文件附带，不依赖Python解释器。
